...
file_path = '/home/ania/Desktop/trace_clustering/services/clustering/temp/logs/cluster_log_2.csv'

async def main():

    #### **************** testing the functions **********

    # print(await inductive_miner(file_path, 0))
    # await heuristic_miner(file_path, 0.5 , 0.65,0.5 )
    # await alpha_miner_algo(file_path)
    # await process_animate(file_path)
    # print(await dfg_precision(file_path))
    print(await heuristic_miner_petri(file_path, "token based", "token based"))
